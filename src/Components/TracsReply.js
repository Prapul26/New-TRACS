                ...
                <div className="card card-main shadow-lg rounded-4 w-100">
                    ...
                    <div className="card-header bg-dark text-white p-3 p-sm-4 d-flex justify-content-between align-items-center">
                        ...
                        <button className="btn btn-primary btn-sm d-flex align-items-center py-2 px-2 px-sm-3">
                            ...
                            <span className="d-none d-sm-inline">Message History</span>
                        </button>
                    </div>
                    ...
                    <form id="message-form" className="card-body p-3 p-sm-4" onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            ...
                            <input 
                                type="text" 
                                id="subject" 
                                defaultValue="Intro: Manjrekar Sanjay <> S Kumar Nelli & You" 
                            ...
                            <div className="border rounded-3 p-3 shadow-sm mt-2">
                                ...
                                <div className="form-check mb-2">
                                    ...
                                    <label htmlFor="receiver1" className="form-check-label ms-2">
                                        S Kumar Nelli <span className="text-muted fw-normal">(s.kumar.nelli@example.gov)</span>
                                    </label>
                                </div>
                                {/* Receiver 2 */}
                                <div className="form-check">
                                    <input ref={receiver2Ref} id="receiver2" name="receivers" type="checkbox" className="form-check-input" />
                                    <label htmlFor="receiver2" className="form-check-label ms-2">
                                        Manjrekar Sanjay <span className="text-muted fw-normal">(manjrekar.sanjay@example.gov)</span>
                                    </label>
                                </div>
                            </div>
                        </div>
