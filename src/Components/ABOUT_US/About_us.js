...
const About_us = () => {
    ...
    return (
       ...
       <Header/>
        ...
        <Navbar/>
            <div className='ph1'style={{marginTop:"2px",marginBottom:"20px"}}><div className='p1h1'><h1 style={{fontSize:'35px'}}>About Us</h1></div></div>
            <div className='About_us-container'>
                ...
                <div className='a_4'>
                    <div className='a_41'><img src="https://tracsdev.apttechsol.com/public/uploads/website-images/Our Mission & Vision.jpg"/></div>
